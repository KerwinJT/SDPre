public class EscapeSequencesComments{
  public static void main (String [] args){
    ...
    System.out.print ( "Learn\tJave\n\tthe\nHard\tWay\n\n");
    System.out.print( "\tLearn Jave the \"Hard\" Way!\n");
    // System.out.frimp( "Learn Java the Hard Way");
    System.out.print("Hello\n");//This line prints Hello.
    System.out.print("Jello\by\n");//This line prints Jelly
    /* The quick brown fox jumped over a laxy dog.
       Quick wafting zephyrs vex bold Jim. */
    System.out /*testing*/.println("Hard to believe, eh?"); //Yes it is, actually
